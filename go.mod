...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sqs v1.29.0 // indirect
	...
	github.com/senzing/go-databasing v0.3.1 // indirect
	github.com/senzing/go-grpcing v0.1.3 // indirect
