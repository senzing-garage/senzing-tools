...
require (
	github.com/senzing-garage/check-self v0.3.10
	github.com/senzing-garage/demo-entity-search v0.2.10
...
require (
	...
	github.com/senzing-garage/go-rest-api-service v0.10.11 // indirect
